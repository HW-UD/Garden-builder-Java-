...
public final int WinWidth = 600;
public final int WinLength = 450;
public final int TitleSize = 30;
public final int TextSize = 20;
	...
	public void display(String title , String message){
		    ...
		    Label label2 = new Label("Click by using mouse left key to start drawing your garden, once you release the mouse,it stops drawing.");
		    ...
		    Label label4 = new Label("Choose the plants you want to delete, then doubleclick that plant by leftmouse button.");
