...
public class DragController {
	...
	public static void move(GardenImgView iv1copy) {
		iv1copy.setOnMouseDragged(new EventHandler<MouseEvent>() {
			...
			public void handle(MouseEvent event) {
				...
				Main.getModel().getGarden().removePlant(iv1copy.getID(), iv1copy.getTranslateX(),
						iv1copy.getTranslateY());
	...
	/**
	 * detector for an GardenImgView delete events, able to delete the image from
	 * both pane and Model
	 * 
